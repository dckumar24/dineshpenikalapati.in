...
const AboutProfileDetails=()=>{
    return<AboutProfileDetailsWrapper className="w-full p-4 flex flex-col items-start justify-center sm:w-10/12 sm:flex sm:flex-col sm:items-start sm:justify-center z-40" >
