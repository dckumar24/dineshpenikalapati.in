...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="relative py-32 px-8 md:px-16 lg:px-24 hex-bg overflow-hidden">
      {/* Background accent */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {[
                ...
                <div key={item.label} className="border-l-2 border-[#00f5ff]/30 pl-4">
                  <p className="font-mono text-xs text-[#00f5ff] tracking-widest mb-1">{item.label}</p>
            ...
            <div className="flex gap-4">
              {[
                { label: 'GITHUB', href: profileData.github, color: '#fff' },
